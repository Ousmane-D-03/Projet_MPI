/**
 * @mainpage Projet MPI : Classification et Clustering de Séquences d'ARN
 * 
 * @section intro_sec Introduction
 * 
 * Ce projet implémente un pipeline complet d'analyse de séquences biologiques (ARN/ADN)
 * utilisant des algorithmes de graphe et de clustering distribués avec MPI.
 * 
 ...
 * 
 * @section arch_sec Architecture du Projet
 * 
 * Le projet est organisé en trois modules principaux :
 * 
 * @subsection mod_arn Module ARN
 ...
 * 
 * @subsection mod_floyd Module Floyd-Warshall
 ...
 * 
 * @subsection mod_pam Module PAM (K-Medoids)
 * - Algorithme PAM séquentiel
 * - Algorithme PAM distribué (MPI)
 * - Clustering basé sur une matrice de distances
 * 
 * @section install_sec Installation et Compilation
 * 
 * @subsection prereq_subsec Prérequis
 * 
 ...
 * 
 * @subsection usage_floyd Floyd-Warshall MPI
 * 
 ...
 * @endcode
 * 
 * @subsection usage_pam PAM (K-Medoids)
 * 
 ...
 * @endcode
 * 
 * @subsection usage_arn Pipeline ARN Complet
 * 
 ...
 * @endcode
 * 
 * @section formats_sec Formats de Fichiers
 * 
 * @subsection format_fasta Format FASTA
 * 
 ...
 * 
 * @subsection format_dot Format DOT (Graphviz)
 * 
 ...
 * @endcode
 * 
 * @section algo_sec Algorithmes Implémentés
 * 
 * @subsection algo_lev Distance de Levenshtein
 * 
 * Calcule le nombre minimum d'opérations d'édition (insertion, suppression, 
 * substitution) nécessaires pour transformer une séquence en une autre.
 * 
 * **Complexité** : O(m × n) où m et n sont les longueurs des séquences
 * 
 * **Utilisation** : Séquences de longueurs différentes
 * 
 * @subsection algo_ham Distance de Hamming
 * 
 ...
 * 
 * @subsection algo_floyd Floyd-Warshall
 * 
 ...
 * 
 * @subsection algo_pam PAM (Partitioning Around Medoids)
 * 
 * Algorithme de clustering qui sélectionne k objets représentatifs (médoïdes)
 * et affecte chaque objet au médoïde le plus proche.
 * 
 * **Complexité** : O(k × n² × iter) où iter est le nombre d'itérations
 * 
 * **Avantage** : Robuste aux outliers (contrairement à k-means)
 * 
 * @section parallel_sec Parallélisation MPI
 * 
 * @subsection par_floyd Floyd-Warshall par Blocs
 * 
 ...
 * 
 * @subsection par_pam PAM Distribué
 * 
 ...
 * 
 * @section perf_sec Performances
 * 
 * @subsection perf_scalability Scalabilité
 * 
 ...
 * 
 * @subsection perf_bottlenecks Goulets d'Étranglement
 * 
 ...
 * 
 * @subsection perf_tips Conseils d'Optimisation
 * 
 ...
 * 
 * @section examples_sec Exemples d'Utilisation
 * 
 * @subsection ex_workflow Workflow Complet
 * 
 * @code{.sh}
 ...
 * @endcode
 * 
 * @subsection ex_floyd Floyd-Warshall Seul
 * 
 * @code{.sh}
 ...
 * @endcode
 * 
 * @section tests_sec Tests
 * 
 * @subsection test_run Exécuter les Tests
 * 
 ...
 * @endcode
 * 
 * @subsection test_validation Validation des Résultats
 * 
 ...
 * @endcode
 * 
 * @section limitations_sec Limitations Connues
 * 
 ...
 * 
 * @section future_sec Améliorations Futures
 * 
 * @subsection future_algo Algorithmes
 ...
 * 
 * @subsection future_perf Performances
 ...
 * 
 * @subsection future_features Fonctionnalités
 ...
 * 
 * @section contrib_sec Contribution
 * 
 * @subsection contrib_style Style de Code
 * - C++11 standard
 * - Indentation : 4 espaces
 * - Documentation : Doxygen
 * - Tests unitaires requis
 * 
 * @subsection contrib_process Processus
 * 1. Fork du projet
 ...
 * ---
 * 
 * @note Ce projet nécessite une bonne compréhension des concepts de programmation parallèle
 * et des algorithmes de graphe. Pour une introduction, consulter les références citées.
 * 
 * @warning Les graphes de très grande taille (n > 10000) peuvent nécessiter des ressources
 * importantes. Tester d'abord avec de petits exemples.
 */